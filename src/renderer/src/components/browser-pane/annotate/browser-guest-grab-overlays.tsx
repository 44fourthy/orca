...
/**
 * Everything the grab/annotate tools paint over a guest: the pending comment card, the annotation
 * tray, the right-click grab menu and the inline confirmation toast.
 *
 * Split from the markup overlay because a surface can offer the element picker and the draw tool
 * independently — a surface with its own markup rendering mounts this on its own.
 */
export function BrowserGuestGrabOverlays({
  grab,
  annotationSend,
  grabAnnotations,
  containerRef,
